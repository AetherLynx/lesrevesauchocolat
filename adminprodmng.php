    ...
    <div class="undernav">
        <div class="bodybg">
            ...
            if (isset($_GET["addproduct"])) {
                ...
                echo "
                <form class='prodMng' method='post' action='conns/adminmodifyprod.php' enctype='multipart/form-data'>
                    <p>Modifica los datos de $product_name. [ID={$_SESSION["ADMIN_curModifProd"]}]</p>

                        <div class='main-borderbox main-bordercontx main-center' style='width: 50em;'>
                            <h3>Imagen del producto</h3>
                            <img src='files/products/$product_image' type='catalog' id='pr_output'>
                    ...
                    <div class='main-row'>
                        ...
                        <div class='main-darkcont' c='c' t='c' style='width: 50%; text-align: center'>
                            ...
                            <p>Esto eliminará los datos de la base de datos, borrar la imagen de los archivos de la página y no aparecerá en el catálogo.</p>
