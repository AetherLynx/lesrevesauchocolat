    ...
    if (isset($_FILES["product_imageFILE"]) && $_FILES["product_imageFILE"]["error"] == 0) {
        ...
        if (in_array($filetype, $allowed)) {
            ...
            if (file_exists("files/images/" . $filename)) {
                ...
                $sql = "INSERT INTO productdata (product_id, product_name, product_desc, product_uniprice, product_ingredients, product_category, product_image, product_options, product_creator) VALUES (NULL, '$product_name', '$product_desc', '$product_uniprice', '$product_ingredients', '$product_category', '$filename', '$product_options', '')";
