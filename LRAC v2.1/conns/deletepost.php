...
if (isset($adminProcedure)) {
    createNotification($conn, $post, '11', '?');
}
...
if (isset($adminProcedure)) {
    setPopup("(Admin) Se ha borrado el comentario del usuario.", "../$url");
    die();
}
