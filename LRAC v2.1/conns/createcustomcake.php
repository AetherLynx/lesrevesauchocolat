...
//15 de mayo: sigue yendo a mi carta de suicidio
if (!($_SERVER["REQUEST_METHOD"] == "POST")) {
    setPopup("Hubo un error procesando esa solicitud.", "../index.php");
    die();
}
...
if (isset($_FILES["cakeimg"]) && $_FILES["cakeimg"]["error"] == 0) {
    ...
    if (in_array($filetype, $allowed)) {
        ...
        if (file_exists("files/images/" . $filename)) {
            ...
            $sql = "INSERT INTO productdata (product_id, product_name, product_desc, product_uniprice, product_ingredients, product_category, product_image, product_options, product_creator, cakecode) VALUES (null, '$cakename', '$cakedesc', '$cakeprice', '$cakeing', 'Creacion', '$filename', null, '{$_SESSION["user_id"]}', '$cakecode')";
