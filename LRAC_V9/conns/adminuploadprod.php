        ...
        */
        ...
        if (in_array($filetype, $allowed)) {
            ...
            if (file_exists("files/images/" . $filename)) {
                ...
                $sql = "INSERT INTO productdata (product_id, product_name, product_desc, product_uniprice, product_ingredients, product_category, product_image, product_options) VALUES (NULL, '$product_name', '$product_desc', '$product_uniprice', '$product_ingredients', '$product_category', '$filename', '$product_options')";
