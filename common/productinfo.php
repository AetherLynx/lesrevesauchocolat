        ...
        case "Panaderia":
            echo "
                <script>
                    ...
                    document.documentElement.style.setProperty('--co4ba', '#BF7B69')
                </script>
                ";
            break;
        case "Heladeria":
            echo "
                <script>
                    ...
                    document.documentElement.style.setProperty('--co4ba', '#94ADD7')
                </script>
                ";
            break;
        case "Pasteleria":
            echo "
                <script>
                    ...
                    document.documentElement.style.setProperty('--co4ba', '#E63F74')
                </script>
                ";
            break;
    }
